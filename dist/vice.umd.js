(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('phone'), require('validator')) :
  typeof define === 'function' && define.amd ? define(['exports', 'tslib', 'phone', 'validator'], factory) :
  (global = global || self, factory(global.vice = {}, global.tslib_1, global.phone, global.validator));
}(this, function (exports, tslib_1, phone, validator) { 'use strict';

  phone = phone && phone.hasOwnProperty('default') ? phone['default'] : phone;
  ...
  })(exports.UnexpectedItemBehaviour || (exports.UnexpectedItemBehaviour = {}));
  (function (MissingItemBehaviour) {
      MissingItemBehaviour["IGNORE"] = "ignore";
      MissingItemBehaviour["PROBLEM"] = "problem";
  })(exports.MissingItemBehaviour || (exports.MissingItemBehaviour = {}));
  let BEHAVIOUR = {
      unexpected: exports.UnexpectedItemBehaviour.PROBLEM,
      missing: exports.MissingItemBehaviour.PROBLEM,
  ...
  class BehaviourSchema extends BaseSchema {
      ...
      toJSON(toJson) {
          return Object.assign({}, subSchemaJson(this.subSchema, toJson), { additionalProperties: this.behaviour.unexpected !== exports.UnexpectedItemBehaviour.PROBLEM });
      }
  }
  ...
  function conformInPlace(thing, itemSchemas) {
      ...
      for (const [k, s] of itemSchemas) {
          ...
          if (isError(v) && !thing.has(k)) {
              if (s[optional] !== true && missing !== exports.MissingItemBehaviour.IGNORE) {
      ...
      for (const k of unmatchedThingKeys) {
          switch (unexpected) {
              case exports.UnexpectedItemBehaviour.IGNORE:
                  break;
              case exports.UnexpectedItemBehaviour.DELETE:
                  thing.delete(k);
                  break;
              case exports.UnexpectedItemBehaviour.PROBLEM:
  ...
  })(exports.TimeExpectation || (exports.TimeExpectation = {}));
      ...
      conform(value) {
          if (typeof value === 'string') {
              ...
              try {
                  ...
                  if (value.length === 10 && this.time === exports.TimeExpectation.ALWAYS)
          ...
          if (this.time === exports.TimeExpectation.NEVER && utcDate(value.getUTCFullYear(), value.getUTCMonth(), value.getUTCDate()).getTime() !== value.getTime())
              return failure("date should not have a time of day component");
          return value;
      }
      toJSON() {
          return {
              type: "string", format: this.time === exports.TimeExpectation.ALWAYS
                  ? 'date-time'
                  : this.time === exports.TimeExpectation.NEVER
                      ? 'date'
                      : 'date-time'
          };
      }
  ...
  })(exports.LensBehaviour || (exports.LensBehaviour = {}));
  ...
  const DEFAULT_BEHAVIOUR = {
      missing: exports.MissingItemBehaviour.PROBLEM,
      unexpected: exports.UnexpectedItemBehaviour.IGNORE,
  ...
  class ConditionalSchema extends BaseSchema {
      ...
      case(case_, schema) {
          const caseSchema = isSchema(case_)
              ? case_
              : new BehaviourSchema({ unexpected: exports.UnexpectedItemBehaviour.IGNORE }, new ObjectSchema(case_));
  ...
  function intersect(a, b) {
      ...
      Intersection = tslib_1.__decorate([
          hasSchema(schema)
      ], Intersection);
  ...
  function partial(type) {
      return onMissing(schemaOf(type), exports.MissingItemBehaviour.IGNORE);
  }
  ...
  function isobject() {
      return withBehaviour(new ObjectSchema({}), { unexpected: exports.UnexpectedItemBehaviour.IGNORE });
  }
  ...
  const DATE_TIME = new IsoUtcDateSchema(exports.TimeExpectation.ALWAYS);
  function isoUtcDateTime() {
      return DATE_TIME;
  }
  const DATE = new IsoUtcDateSchema(exports.TimeExpectation.NEVER);
  ...
  function deepPartial(pattern) {
      return onUnexpected(new ObjectSchema(pattern), exports.UnexpectedItemBehaviour.IGNORE);
  }
  /**
...
//# sourceMappingURL=vice.umd.js.map
